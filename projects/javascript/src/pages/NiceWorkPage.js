...
const POPUP_MESSAGES = [
  ...
  'WARNING: THIS PERSON IS A DUMBASS.',
  'ALERT: This person is a dumbass!!',
  'Critical error: competence not found',
  'Brain.exe has stopped responding',
  '404: Thoughts not found',
  'WARNING: Dumbass detected',
  'Not helpful.',
  'Achievement unlocked: Still an idiot',
  'This incident will be reported.',
  'Task failed successfully.',
  'Warning: Stupidness found',
  'Recalculating… you are still dumb',
  'You borked this one, for real.',
  'Please contact your nearest hosiptal for a stupidectomy.',
  'Executing 0xIDIOT: Your are dumb.',
  'Intelligence not found: shame.exe',
  'Security alert: Dumbass found',
  'CAUTION High Risk of Failure: Operation completed anyway',
];
